...
try:
    ...
    # Step - 1 : Click on the COLOR button in the top left grid
    ...
    # Step - 2 : Click on the 'TEXT' button in the middle left section
    ...
    # Step - 3 : Click on the 'TOAST' button in the middle left section
    ...
    # Step - 4 : Click on the GEOLOCATION button
