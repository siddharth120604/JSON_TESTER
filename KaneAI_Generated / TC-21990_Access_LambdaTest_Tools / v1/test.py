...
try:
    ...
    # Step - 3 : Click on 'Tools' link in the Resources section footer
    element_locators = ["//span[@id='exit_popup_close']/img[1]", "//span[@id='exit_popup_close']/img[1]", '#exit_popup_close > img', '#exit_popup_close > img:nth-child(1)', '#exit_popup_close > img:nth-child(1)']
