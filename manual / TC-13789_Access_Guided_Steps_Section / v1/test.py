...
try:
    ...
    # Step - 2 : Click on the guided steps section on the left side
    element_locators = ["//div[contains(@class,'layout')]/div[1]", '.layout > div:nth-child(3)', '.layout > div:nth-child(3)', '.layout > div:nth-child(3)', 'div:has(+ #validationPopup)', "//div[contains(@class,'layout')]/div[1]", "//div[contains(@class,'layout')]/div[1]"]
    ...
    # Step - 3 : Click on the main guided-steps section of the page
    element_locators = ["//div[contains(@class,'layout')]/div[1]", '.layout > div:nth-child(3)', '.layout > div:nth-child(3)', '.layout > div:nth-child(3)', 'div:has(+ #validationPopup)', "//div[contains(@class,'layout')]/div[1]", "//div[contains(@class,'layout')]/div[1]"]
    element = get_element(driver,element_locators)
